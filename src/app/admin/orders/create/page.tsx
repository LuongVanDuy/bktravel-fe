...
const CreateOrder = (props: any) => {
  const { fetchTours, tourList, fetchPayments, paymentList, createOrder } = props;
  ...
  const handleFinish = async (values: any) => {
    createOrder(session?.user.accessToken, values, () => onSuccess("Đặt tour thành công"), onFailure);
  };
          ...
          <Col xs={24} md={15}>
            <Card size="small" title="Danh sách tour" style={{ marginBottom: 15 }}>
              ...
              <Form.Item name="totalPrice" noStyle>
                <Input value={form.getFieldValue("totalPrice")} />
              </Form.Item>
            </Card>
